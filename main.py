...
def main(args, ITE=0):
    ...
    if args.dataset == "mnist":
        ...
        traindataset = datasets.ImageNet('http://www.image-net.org/challenges/LSVRC/2012/nnoupb/ILSVRC2012_img_train.tar', split='train', download=True)
        testdataset = datasets.ImageNet('http://www.image-net.org/challenges/LSVRC/2012/nnoupb/ILSVRC2012_img_val.tar', split='val', download=True)
