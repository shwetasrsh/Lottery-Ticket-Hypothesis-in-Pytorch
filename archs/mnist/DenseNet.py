...
class _DenseLayer(nn.Sequential):
    ...
    def __init__(self, num_input_features, growth_rate, bn_size, drop_rate):
        ...
        if bn_size > 0:
            ...
            self.add_module('conv.1', nn.Conv2d(num_input_features, interChannels, kernel_size=1, stride=1, bias=False))
            ...
            self.add_module('conv.2', nn.Conv2d(num_input_features, growth_rate, kernel_size=3, stride=1, padding=1, bias=False))
